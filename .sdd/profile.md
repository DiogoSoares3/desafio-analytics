...
- **Fresh-agent mode:** `subagent` — spawn a fresh agent per **phase** with each issue inside the backlog's
  phase a git worktree branch. Uses the branch-per-issue flow below.
